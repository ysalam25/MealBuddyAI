...
import { Formik, Field } from 'formik';
import { Auth } from 'aws-amplify';
import { Box, Text as TamaguiText, Button as TamaguiButton } from 'tamagui';
import MultiSelect from 'react-native-multiple-select';
...
const DietaryPreferences = ({ navigation }) => {
  ...
  return (
    <Box as="form" onSubmit={handleSubmit}>
      <TamaguiText variant="h2">What are your dietary preferences?</TamaguiText>
      <Formik
        initialValues={{
          dietaryRestrictions: [],
          nutritionGoals: [],
...
{({ handleChange, handleBlur, handleSubmit, values, setFieldValue }) => (
          <>
            <Box>
              <TamaguiText variant="h3">Dietary Restrictions:</TamaguiText>
              <MultiSelect
                // ...
              />

              <TamaguiText variant="h3">Nutrition Goals:</TamaguiText>
              <MultiSelect
                // ...
              />
            </Box>

            <TamaguiButton type="submit">Submit</TamaguiButton>
          </>
        )}
      </Formik>
    </Box>
