...
import AntDesignGlyphMap from '@expo/vector-icons/AntDesign';

// This type should include all valid icon names from AntDesign
type IconName = Exclude<keyof typeof AntDesignGlyphMap, 'defaultProps'>;
...
// Define the component with TypeScript type
